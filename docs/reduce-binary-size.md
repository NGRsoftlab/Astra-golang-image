...
- [Initial state](#initial-state)
  ...
  - [Simple tricks](#simple-tricks)
    - [1. Strip](#1-strip)
    - [2. Disable function inlining](#2-disable-function-inlining)
    - [3. Disable bounds checks](#3-disable-bounds-checks)
    - [4. Disable write-barrier](#4-disable-write-barrier)
    - [5. Other `gcflags`](#5-other-gcflags)
    - [6. Compress the binary](#6-compress-the-binary)
    - [7. 32bits instead of 64bits](#7-32bits-instead-of-64bits)
    - [8. Strip function names](#8-strip-function-names)
    - [9. Use GCCGo](#9-use-gccgo)
  - [Dead code elimination (DCE) considerations](#dead-code-elimination-dce-considerations)
    - [Avoid visibility of `reflect.Call`](#avoid-visibility-of-reflectcall)
    - [GCCGo](#gccgo)
    - [Downgrade version of Golang](#downgrade-version-of-golang)
    - [Upgrade version of Golang](#upgrade-version-of-golang)
  - [Other considerations](#other-considerations)
    - [Project "TinyGo"](#project-tinygo)
    - [Remove `runtime.pcntltab`](#remove-runtimepcntltab)
  - [Going deeper](#going-deeper)
    - [Find the causer: `go tool nm`](#find-the-causer-go-tool-nm)
...
- [text/template: avoid a global map to help the linker's dead code elimination](https://go-review.googlesource.com/c/go/+/210284/).
- and so on.
...
- If I remember correctly it does not support Go's plan9 assembly language.
